...
NOISE_RADIUS_MULTIPLIER = 0.5
NOISE_GROWTH_EVERY_STEPS = 3
BASE_NOISE_POINTS_PER_TYPE = 4
NOISE_POINTS_PER_GROWTH = 1
FOCUS_ACCELERATION_START_STEP = 20
TARGET_FLOOD_START_STEP = 32
TARGET_ROUTE_LOCK_STEP = 42
ROAD_CLOSURE_PERSISTENCE_STEPS = 6
FOCUS_ROUTE_FRACTION = 0.62
FLOOD_LINK_DISTANCE_M = 380.0
FLOOD_NEIGHBORHOOD_DISTANCE_M = 300.0
FLOOD_RAIN_NEIGHBORS_REQUIRED = 3
FLOOD_WIND_SUPPORT_REQUIRED = 1
ROAD_CLOSURE_TRIGGER_SCORE = 75.0
OFF_ROUTE_CLUSTER_COUNT = 3
OFF_ROUTE_CLUSTER_BASE_POINTS = 2
WIND_TO_RAIN_RATIO = 3
MAX_FLOODS_PER_STEP = 14
MAX_CLOSURES_PER_STEP = 8
MAX_AFFECTED_AREAS = 100
